...
const MARQUEE =
  "JAVA  ·  SPRING BOOT  ·  REACT  ·  NEXT.JS  ·  TYPESCRIPT  ·  MONGODB  ·  POSTGRESQL  ·  MYSQL  ·  AWS  ·  JENKINS  ·  GIT  ·  ";
...
const FEATURED = [
  {
    ...
    img: {
      src: "/uploads/parichay.webp",
      alt: "Parichay — marriage biodata studio",
      pos: "50% 20%",
    },
  },
  {
    ...
    img: {
      src: "/uploads/mangaverse.webp",
      alt: "MangaVerse — full-stack manga reading platform",
      pos: "50% 0%",
    },
    alt: true,
  },
  {
    ...
    img: {
      src: "/uploads/slot-quizzler.webp",
      alt: "The Quizzler — microservices quiz platform",
    },
  },
  {
    ...
    img: {
      src: "/uploads/mdtopdf.webp",
      alt: "MdToPdf — Markdown to PDF converter",
      pos: "50% 0%",
    },
    alt: true,
  },
  {
    ...
    img: {
      src: "/uploads/codeoverflow.webp",
      alt: "CodeOverflow — developer Q&A platform",
      pos: "50% 0%",
    },
  },
];
  ...
  return (
    <>
      ...
      <main ref={pageRef} className="page">
        ...
        <section className="stat-grid" data-reveal-group="1">
          {STATS.map((s) => (
            <div className="stat-card" data-tilt="1" key={s.num}>
              <p className="stat-num" data-count="1">
                {s.num}
              </p>
              <p>{s.label}</p>
            </div>
          ...
          <div className="feat-grid" data-reveal-group="1">
            {FEATURED.map((p) => (
              <Link to="/work" className="feat-card" key={p.title}>
                <div
                  className={
                    p.alt ? "feat-media feat-media--alt" : "feat-media"
                  }
                >
                  {p.img ? (
                    <img
                      ...
                      loading="lazy"
                      decoding="async"
                      style={{ objectPosition: p.img.pos }}
                    />
                  ) : (
        ...
        <section className="section">
          <h2 className="section-title" data-reveal="rise">
            What I bring
          </h2>
          <div className="bring-grid" data-reveal-group="1">
            {BRING.map((b) => (
              <div className="bring-card" key={b.title}>
                <div
                  className={
                    b.alt ? "bring-icon bring-icon--alt" : "bring-icon"
                  }
                >
                  <span />
                </div>
